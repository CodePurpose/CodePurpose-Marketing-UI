    ...
    <CareersBackground id="careers">
      <CareersContainer>
        ...
        <CareersTextContainer>
          ...
          <CareersText>
            First, ask yourself what you bring to the table. Next, shoot us an email. 
            We like résumés but we also don’t like résumés. If that’s your thing, fine, 
            if it’s not, send us a link to your portfolio, blog, or whatever else you use to represent
